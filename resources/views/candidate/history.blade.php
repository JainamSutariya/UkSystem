...
h5.firt-btn-text, .firt-btn-text2, .firt-btn-text3, .firt-btn-text4, .firt-btn-text5, .firt-btn-text6, .firt-btn-text7 {
    font-family: "Cantata" !important;
    font-size: 20px;
}
.page-title-right {
    font-size: 22px;
         ...
         <div class="row sec-div">
                <div class="col-md-12 single-div">
                    ...
                    <div class="col-md-8">
                        <h4 class="head-contain">
                           Account Created ({{ Auth::user()->created_at->format('M d Y')}}, {{ Auth::user()->created_at->format('g:i A') }})
                        </h4>
                    </div>
                </div>
                <div class="col-md-12 single-div">
                ...
                <div class="col-md-12 single-div">
                    ...
                    <div class="col-md-10">
                        ...
                        <h4 class="sec-head-contain appor-text-btn view-6">
                            Reference verification status <button class="approve-btn">Approve</button><button class="approve-btn" style="background-color:red;">Reject1</button>&nbsp;&nbsp;(1 Reference Pending)
                        </h4>
                        @else
                ...
                <div class="col-md-12 single-div">
                    ...
                    <div class="col-md-8">
                    @if ($candidate->is_complete == 'No')
                        <h4 class="sec-head-contain" style="margin-left: -33px;">
