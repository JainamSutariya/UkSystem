...
@section('title') Covid 19 Staff Confirmation Statement List @endsection
...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('title') Covid 19 Staff Confirmation Statement List @endslot
    @endcomponent
...
@section('script')
    ...
    <script>
        var table = $('.yajra-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('getCovid19StatementList') }}",
            columns: [
                {data: 'id', name: 'id'},
