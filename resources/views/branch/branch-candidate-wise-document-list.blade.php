                        ...
                        <form method="POST" action="{{ route('submitForm') }}" enctype="multipart/form-data">
                            ...
                            <table class="table table-nowrap align-middle mb-0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="{{ route('candidate.show', ['candidate' => $id]) }}" class="text-dark">JOB APPLICATION FORM</a></h5>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="{{ route('interviewScreening', ['id' => $id]) }}" class="text-dark">TELEPHONIC INTERVIEW</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"></h5>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="{{ route('basicEnglishTest', ['id' => $id]) }}" class="text-dark">INTERVIEW</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"></h5>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="{{ route('liveInterviewQuestion', ['id' => $id]) }}" class="text-dark">LIVE INTERVIEW NOTE</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"></h5>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="{{ route('aplicationIdentity', ['id' => $id]) }}" class="text-dark">APPLICANT IDENTITY CHECK</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"></h5>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="#" class="text-dark">RIGHT TO WORK</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0">
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="#" class="text-dark">CONDITIONAL OFFER LETTER</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0">
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="{{ route('dbsCheck', ['id' => $id]) }}" class="text-dark">DBS CONFIRMATION LETTER</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"></h5>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="#" class="text-dark">REFERENCE</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"></h5>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="#" class="text-dark">OFFER LETTER</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0">
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="#" class="text-dark">GDPR AGREEMENT</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0">
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="#" class="text-dark">STAFF RISK ASSESSMENT</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"></h5>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="1">
                                            <h4 class="text-truncate font-size-14 m-0">03. COVID VACCINATION RECORD</h4>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0">
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="#" class="text-dark">EMPLOYMENT CONTRACT</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0">
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="#" class="text-dark">COVID-19 STAFF CONFIRMATION STATEMENT</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0">
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0"><a href="#" class="text-dark">AVAILABILITY FORMS</a></h5>
                                        </td>
                                        <td>
                                            <h5 class="text-truncate font-size-14 m-0">
